            ...
            <div class="card o-hidden border-0 shadow-lg mb-3 mt-5">
                <div class="card-body p-4">
                    ...
                    <div class="text-center">
                        <h1 class="h5 text-gray-900 mb-3">تسجيل الدخول</h1>
                    </div>
                    <form action="{{ route('login') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label class="font-weight-bold text-uppercase">عنون البريد</label>
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold text-uppercase">كلمة المرور</label>
