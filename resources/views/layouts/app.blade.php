    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/dashboard">
                ...
                <div class="sidebar-brand-text mx-3">متجر إلكتروني</div>
            </a>
            <!-- Divider -->
            ...
            <li
                ...
                <div id="collapseTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">الاقسام و المنتجات</h6>
                        <a class="collapse-item {{ Request::is('category*') ? ' active' : '' }}"
                            href="{{ route('category.index')  }}">الاقسام</a>
                        <a class="collapse-item {{ Request::is('product*') ? ' active' : '' }}"
                            href="{{ route('product.index') }}">المنتجات</a>
                    </div>
                </div>
            </li>
            <div class="sidebar-heading">
            ...
            <li class="nav-item {{ Request::is('slider*') ? ' active' : '' }}">
                <a class="nav-link" href="{{ route('slider.index')}}">
                    ...
                    <span>القائمة المنسدلة</span></a>
            </li>
            {{-- <li class="nav-item {{ Request::is('profile*') ? ' active' : '' }}">
                <a class="nav-link" href="#">
                    <i class="fas fa-user-circle"></i>
                    <span>الصفحة الشخصية</span></a>
            </li> --}}
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{ route('front.home.page') }}" style="cursor: pointer">
                                <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400 "></i>صفحة المستخدمين</a>

                                <a class="dropdown-item" href="{{ route('logout') }}" style="cursor: pointer"
                                    onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                    <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400 "></i>تسجيل الخروج</a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>سوفت للبرمجة &copy; 2022 لارافل | سن سي </span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
