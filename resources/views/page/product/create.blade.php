@extends('layouts.app', ['title' => 'إضافة منتج'])
@section('content')
<!-- Begin Page Content -->
        ...
        <div class="col-md-12">
            <div class="card border-0 shadow">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold"><i class="fas fa-shopping-bag"></i> إضافة منتج</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>صورة المنتج <span style="color : red"> *</label>
                            <input type="file" name="file" class="form-control">
                            <small class="form-text text-danger">{{ $errors->first('file') }}</small>
                        </div>
                        <div class="form-group">
                            <label>اسم المنتج <span style="color : red"> *</label>
                            <input type="text" name="title" value="{{ old('title') }}"
                                placeholder="ادخل اسم المنتج" class="form-control">
                            <small class="form-text text-danger">{{ $errors->first('title') }}</small>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>الاقسام <span style="color : red"> *</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>السعر <span style="color : red"> *</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="discount" class="form-control "
                                        value="{{ old('discount') }}" placeholder="نسبة الخصم (%)">
