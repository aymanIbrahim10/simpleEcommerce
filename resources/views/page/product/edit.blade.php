@extends('layouts.app', ['title' => 'تعديل المنتج'])
@section('content')
<!-- Begin Page Content -->
        ...
        <div class="col-md-12">
            <div class="card border-0 shadow">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold"><i class="fas fa-shopping-bag"></i> تعديل المنتج</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('product.update', $product->id) }}" method="POST"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="weight" class="form-control "
                                        value="{{ old('weight', $product->weight) }}" placeholder="وزن المنتج (جرام)">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control content" name="content" rows="6"
                                placeholder="وصف المنتج">{{ old('content', $product->content) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price" class="form-control"
                                        value="{{ old('price',$product->price) }}" placeholder="سعر المنتج">
