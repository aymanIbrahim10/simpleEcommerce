@extends('layouts.front', ['title' => 'ماذا عننا'])
@section('content')
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
				<div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-fluid" src="{{ asset('front/images/about-img.jpg') }}" alt="" />
                    </div>
                </div>
                <div class="col-lg-6">
                    <h2 class="noo-sh-title-top">نحن مجموعة <span>شوب للتسوق</span></h2>
            ...
            <div class="row my-5">
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <h3>نحن موثوقون</h3>
                        <p>
                            نحن الافضل في السوق من حيث وصول منتجاتنا و من ناحية اسعارنا فاسعارنا لا تقارن ابدا
                        </p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <h3>نحن محترفون</h3>
                        <p>
                            نحن الاقدم في هذا المجال ولا نملك سوى الاشخاص المحترفون
                        </p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <h3>نحن خبراء</h3>
                        <p>
                            اكثر من 20 عاما من التفوق و التقدم في مجال التسويق الالكتروني
                        </p>
                    </div>
                </div>
            </div>
            <div class="row my-4">
                <div class="col-12">
                    <h2 class="noo-sh-title">قابل فريقنا</h2>
                </div>
